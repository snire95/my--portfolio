  ...
  <header className="bg-blue-300">
   <div className= "container mx-auto flex justify-between">
    <nav className="flex">
     ...
     <NavLink to="/post" className="inline-flex item-center py-3 px-3 my-6 rounded text-red-100 hover:text-blue-500"      activeClassName="bg-blue-700"
>
      Blog Posts
     </NavLink>     
     <NavLink to="/project" className="inline-flex item-center py-3 px-3 my-6 rounded text-red-100 hover:text-blue-500" activeClassName="bg-blue-700">
      Projects
     </NavLink>
     <NavLink to="/about" className="inline-flex item-center py-3 px-3 my-6 rounded text-red-100 hover:text-blue-500" activeClassName="bg-blue-700">
      About me!
     </NavLink>
    </nav>
